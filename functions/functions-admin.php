...
function cristian_remove_dashboard_widgets() {
...
add_action('wp_dashboard_setup', 'cristian_remove_dashboard_widgets' );
...
function remove_footer_admin(){
    echo '<span id="footer-thankyou">powered by <a href="https://cristianarmeanu.com/" target="_blank">Cristian Armeanu</a></span>';
}
